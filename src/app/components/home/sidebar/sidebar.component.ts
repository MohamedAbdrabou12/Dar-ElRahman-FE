...
export class SidebarComponent implements OnInit {
  ...
  private allMenuItems: MenuItem[] = [
    ...
    {route: AppRoutes.STUDENT, label: 'الطلبة', icon: 'fas fa-user-graduate', roles: ['ADMIN', 'SUPERVISOR', 'TEACHER', 'TECHNICAL']},
    ...
    {route: AppRoutes.ABSENCE, label: 'الغياب', icon: 'fas fa-user-check', roles: ['ADMIN', 'SUPERVISOR', 'TEACHER', 'TECHNICAL']},
    {route: AppRoutes.QUESTIONNAIRE, label: 'أسئلة القرآن', icon: 'fas fa-quran', roles: ['ADMIN', 'SUPERVISOR', 'TEACHER']},
    {route: AppRoutes.EXAM_DISTRIBUTION, label: 'توزيع أسئلة القرآن', icon: 'fas fa-clipboard-list', roles: ['ADMIN', 'SUPERVISOR', 'TEACHER', 'TECHNICAL']},
    {route: AppRoutes.EXAM_SCHEDULE, label: 'جدول أسئلة القرآن', icon: 'fas fa-calendar-day', roles: ['ADMIN', 'SUPERVISOR', 'TECHNICAL']},
    {route: AppRoutes.STUDENT_QUESTIONNAIRE, label: 'نتائج الطلبة', icon: 'fas fa-user-graduate', roles: ['ADMIN', 'SUPERVISOR', 'TEACHER', 'TECHNICAL']},
    {route: AppRoutes.TEACHER_RESULT, label: 'نتائج عمل المُعَلِمين', icon: 'fas fa-chart-line', roles: ['ADMIN', 'SUPERVISOR']},
    {route: AppRoutes.GRADUATES, label: 'قائمة الخريجين (النور)', icon: 'fas fa-graduation-cap', roles: ['ADMIN', 'SUPERVISOR', 'TECHNICAL']},
    {route: AppRoutes.TUITIONS, label: 'الرسوم الشهرية', icon: 'fas fa-money-bill-wave', roles: ['ADMIN', 'SUPERVISOR']},
    {route: AppRoutes.SALARY_CONFIG, label: 'شرائح الرواتب', icon: 'fas fa-money-check-alt', roles: ['ADMIN']},
    {route: AppRoutes.REPORTS, label: 'التقارير', icon: 'fas fa-file-alt', roles: ['ADMIN', 'SUPERVISOR', 'TECHNICAL']},
    {route: AppRoutes.STAFF, label: 'الموظفون', icon: 'fas fa-id-badge', roles: ['ADMIN', 'SUPERVISOR']},
  ];
